...
import tankwarsgame.game.GameWorld;
import tankwarsgame.game.ResourceManager;
import tankwarsgame.game.Sound;
import tankwarsgame.menus.EndGamePanel;
import tankwarsgame.menus.StartMenuPanel;
import javax.swing.*;
import java.awt.*;
...
public class Launcher {
    ...
    public void setFrame(String type){
        Sound MainMenu = ResourceManager.getSound("background");
        MainMenu.loopContinuously();
        MainMenu.play();
        ...
        switch (type) {
            ...
            case "game" -> {
                // set the size of the jFrame to the expected size for the game panel q
