...
public class TankControl implements KeyListener {
    ...
    public TankControl(Tank t1, int up, int down, int left, int right, int shoot, int parry) {
        this.t1 = t1;
        this.up = up;
        this.down = down;
        this.right = right;
    ...
    public void keyReleased(KeyEvent ke) {
        ...
        if (keyReleased == parry){
            this.t1.unToggleParryPressed();
        }
    }
}
